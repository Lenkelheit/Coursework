namespace Galagram.ViewModel.Commands.User.MainWindow
{
    ...
    public class ShowFollowingListCommand : CommandBase
    {
        ...
        // CONSTRUCTORS
        /// <summary>
        /// Initialize a new instance of <see cref="ShowFollowingListCommand"/>
        /// </summary>
        ...
        public override void Execute(object parameter)
        {
            ...
            mainWindowViewModel.WindowManager.ShowWindowDialog(key: nameof(Window.User.Follow),
                                                               viewModel: new ViewModel.User.FollowViewModel(mainWindowViewModel.User, Enums.User.FollowMode.Following));
        }
    }
}
